...
%At this point, we can use the optimization capability of anfis to improve the model. First, we will try using a relatively short anfis training (20 epochs) %without implementing the checking data option, but test the resulting FIS model against the test data. The command-line version of this is as follows.
